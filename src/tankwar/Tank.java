...
public class Tank {
	    ...
	    public Tank(int x,int y, boolean self, ArrayList<Tank> allTank, ArrayList<Wall> walls, ArrayList<Iron> irons, ArrayList<Gold> golds,
				     ArrayList<Missle> missles, Home home, ArrayList<Boom>booms, int style, int flag, int tile) throws Exception {
	    ...
	    public void move() {
		if ( up && getY()>0 && noMove(getX(), getY()) && noMove(getX() + SIZE - 1,getY() - speed) )
			setY(getY() - speed);
		...
		for (int i = 0; i < allTank.size(); i++) {
			if( willX > allTank.get(i).getX() && willX < allTank.get(i).getX() + SIZE && willY > allTank.get(i).getY() && willY < allTank.get(i).getY() + SIZE )
				return false;
		}
		for (int i = 0; i < walls.size(); i++) {
			if( willX > walls.get(i).getX() && willX < walls.get(i).getX() + SIZE && willY > walls.get(i).getY() && willY < walls.get(i).getY() + SIZE )
				return false;
		}
		for (int i = 0; i < irons.size(); i++) {
			if( willX > irons.get(i).getX() && willX < irons.get(i).getX() + SIZE && willY > irons.get(i).getY() && willY < irons.get(i).getY() + SIZE )
				return false;
		}
		for (int i = 0; i < golds.size(); i++) {
			if( willX > golds.get(i).getX() && willX < golds.get(i).getX() + SIZE && willY > golds.get(i).getY() && willY < golds.get(i).getY() + SIZE )
				return false;
		}
		if( willX >home.getX() && willX < home.getX() + SIZE && willY > home.getY() && willY < home.getY() + SIZE )
			return false;
		return true;
	}
